...
$query = sprintf("SELECT nome, email, telefone, celular, rua , bairro, cidade, estado , cep FROM usuario_sem_cep");
// executa a query
  ...
  <body>
    <div id="page">
      ...
      <header class="header-container">
        ...
        <h2 align="center">Dados de Pessoas onde nosso serviço AINDA NÃO pode atender.</h2> <br><br>
       ...
       <div align="center">
           ...
           <?php
            ...
            if($total > 0) {
                ...
                do {
                    ?>
                    <p>Nome = <?=$linha['nome']?> | CEP = <?=$linha['cep']?> | Email = <?=$linha['email']?> | Telefone = <?=$linha['telefone']?></p>
                    <?php
        ...
        <div align="center">
            <ul class="list-unstyled nav1 cl-effect-10">
                <li><a data-hover="Cad. com CEP" href="consulta_cadastrados_com_cep.php"><span>Cad. com CEP</span></a></li>
				<li><a data-hover="Adm. CEP" href="admincep.html"><span>Adm. CEP</span></a></li>
            </ul>
        </div>
    </body>
    </html>
