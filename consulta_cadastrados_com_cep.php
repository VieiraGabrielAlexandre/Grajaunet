...
$query = sprintf("SELECT nome, email, telefone, celular, rua , bairro, cidade, estado , cep FROM usuario_com_cep");
// executa a query
  ...
  <body>
    <div id="page">
      ...
      <header class="header-container">
        ...
        <div align="center">
            <ul class="list-unstyled nav1 cl-effect-10">
                <li><a data-hover="Cad. sem CEP" href="consulta_cadastrados_sem_cep.php"><span>Cad. sem CEP.</span></a></li>
